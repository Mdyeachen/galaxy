const Planet = () => {
    return (
        <>
            ...
            {/* first ring */}
            <div className="absolute h-95 w-95 md:h-130 md:w-130  top-1/2 left-1/2 -translate-1/2 opacity-20 rounded-full border ">
            ...
            {/* second ring */}
            <div className="absolute h-120 w-120 md:h-155 md:w-155 top-1/2 left-1/2 -translate-1/2 rounded-full border border-white/20"></div>

            {/* third ring */}
            <div className="absolute h-145 w-145 md:h-190 md:w-190 top-1/2 left-1/2 -translate-1/2 rounded-full border opacity-20">
                <div className="absolute h-2 w-2 bg-white rounded-full top-1/2 left-0 -translate-x-1/2"></div>
                <div className="absolute h-5 w-5 border rounded-full left-full top-1/2 -translate-x-1/2 flex justify-center items-center">
                    <div className="h-2 w-2 bg-white rounded-full"></div>
                </div>
